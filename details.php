        ...
        <div class="row g-4">
            <div class="col-lg-6">
                <img src="images/<?php echo htmlspecialchars($voyage['image']); ?>"
                    alt="<?php echo htmlspecialchars($voyage['destination']); ?>" class="img-fluid voyage-image w-100">
            </div>
            ...
            ?>
                        <div class="accordion-item mb-2 border">
                            ...
                            <div id="collapse<?php echo $p['jour']; ?>" class="accordion-collapse collapse"
                                aria-labelledby="heading<?php echo $p['jour']; ?>" data-bs-parent="#programmeAccordion">
    ...
    <section class="avis-section">
        ...
        ?>
                <div class="mb-4 pb-3 border-bottom avis-item">
                    ...
                    <p class="mb-0"><?php echo nl2br(htmlspecialchars($avis['commentaire'])); ?></p>
                </div>
                <?php 
          endwhile;
        else:
